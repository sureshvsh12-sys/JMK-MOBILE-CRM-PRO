...
const styles = StyleSheet.create({
  ...
  eyebrow: { color: "#93C5FD", fontSize: 10, fontWeight: "900", letterSpacing: 1.4 },
  ...
  heroMetric: {
    ...
    backgroundColor: "rgba(4,14,29,0.40)",
    borderWidth: 1,
    borderColor: "rgba(255,255,255,0.10)",
  },
  heroMetricValue: { color: COLORS.white, fontSize: 18, fontWeight: "900" },
  heroMetricLabel: { marginTop: 4, color: "#9CB1C5", fontSize: 10, fontWeight: "700" },
  error: {
    padding: SPACING.md,
  ...
  miniMetricValue: { color: COLORS.text, fontSize: 15, fontWeight: "900" },
